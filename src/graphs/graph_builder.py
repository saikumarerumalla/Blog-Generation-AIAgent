...
class GraphBuilder:
    ...
    def build_language_graph(self):
        """Builds a graph for generating blog based on the topics and language."""
        self.blog_node = BlogNode(self.llm)
        ...
        self.graph.add_node("telugu_translation", lambda state: self.blog_node.translation({**state, "current_language":"Telugu"}))
        ...
        self.graph.add_conditional_edges(
            ...
            {"hindi": "hindi_translation", "french": "french_translation", "telugu": "telugu_translation"}
            )
